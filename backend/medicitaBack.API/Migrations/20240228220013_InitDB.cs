        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PerfilMedico = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Activo = table.Column<bool>(type: "bit", nullable: false),
                    DatosId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicoId = table.Column<int>(type: "int", nullable: false),
                    FechaCitaUpdate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistorialCitas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HistorialCitas_Medicos_MedicoId",
                        column: x => x.MedicoId,
                        principalTable: "Medicos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ListaCita = table.Column<int>(type: "int", nullable: false),
                    MedicoId = table.Column<int>(type: "int", nullable: false),
                    CitaId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListaCitas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ListaCitas_Citas_CitaId",
                        column: x => x.CitaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ListaCitas_CitaId",
                table: "ListaCitas",
                column: "CitaId");

            migrationBuilder.CreateIndex(
                name: "IX_ListaCitas_MedicoId",
                table: "ListaCitas",
                column: "MedicoId");
