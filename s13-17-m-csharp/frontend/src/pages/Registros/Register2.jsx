      ...
      <form>
        ...
        <fieldset>
          ...
          <div className="container-opcionessexo">
            ...
            <label className="label-opcionessexo" htmlFor="masculino">
              <div className="circle"></div>
              Masculino
            </label>
            <input type="radio" id="femenino" name="genero" />
            <label className="label-opcionessexo" htmlFor="femenino">
              <div className="circle"></div>
              Femenino
            </label>
            <input type="radio" id="nodecirlo" name="genero" />
            <label className="label-opcionessexo" htmlFor="nodecirlo">
              <div className="circle"></div>
              Prefiero no decirlo
            </label>
          </div>
